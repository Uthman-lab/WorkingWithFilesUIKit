...
#ifndef WORKINGWITHFILESUIKIT_SWIFT_H
#define WORKINGWITHFILESUIKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WorkingWithFilesUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21WorkingWithFilesUIKit11AppDelegate")
...
SWIFT_CLASS("_TtC21WorkingWithFilesUIKit21GalleryViewController")
...
@interface GalleryViewController (SWIFT_EXTENSION(WorkingWithFilesUIKit)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UICollectionViewCell;

@interface GalleryViewController (SWIFT_EXTENSION(WorkingWithFilesUIKit)) <UICollectionViewDataSource>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC21WorkingWithFilesUIKit21GestureViewController")
...
SWIFT_CLASS("_TtC21WorkingWithFilesUIKit18MainViewController")
...
@interface MainViewController (SWIFT_EXTENSION(WorkingWithFilesUIKit)) <UIDocumentPickerDelegate>
...
SWIFT_CLASS("_TtC21WorkingWithFilesUIKit13SceneDelegate")
